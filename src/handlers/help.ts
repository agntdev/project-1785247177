...
const HELP =
  "أنا مساعد محادثة عربي مؤقت. اكتب رسالتك وسأتابع معك بالعربية.\n\n" +
  "تنتهي الجلسة بعد فترة من عدم النشاط، ويمكنك إنهاؤها من زر إنهاء الجلسة.";

const backToMenu = inlineKeyboard([[inlineButton("⬅️ القائمة", "menu:main")]]);
